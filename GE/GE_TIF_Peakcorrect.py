...
def Gaussian_FWHM(x,y,center=1200,index=1,info='Gaussian-FWHM_fit'):
...
save_fig=os.path.join(save_folder,f'VisualizeRawImage-{filename}.jpg')
plt.savefig(save_fig)
...
#     plt.title("correction via shift left-")
#     plt.pause(0.1)
#     plt.legend([i for i in range(5)])

# save corrected_list data
corr_datafile=os.path.join(save_folder,f'Peakcorrected_half_n-{half_n}-{filename}.xlsx')
